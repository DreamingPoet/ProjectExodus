...
namespace SceneExport
{
	...
	* whole project (entire project will be processed)"
		...
		[SerializeField] bool excludeSkinnedMeshes = false;
		...
		void processSelectionWarningControls()
		{
			...
			excludeSkinnedMeshes = EditorGUILayout.Toggle("Exclude Skinned Meshes", excludeSkinnedMeshes);
		}
		...
		void configureProject(JsonProject proj)
		{
			if (proj == null) return;
			proj.config.excludeSkinnedMeshes = excludeSkinnedMeshes;
			proj.resourceMapper.excludeSkinnedMeshes = excludeSkinnedMeshes;
		}
