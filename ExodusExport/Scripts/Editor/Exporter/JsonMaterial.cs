...
namespace SceneExport
{
	...
	public class JsonMaterial : IFastJsonValue
	{
		...
		public static class TexParamNames
		{
			...
			//URP params
			public static readonly string urpMain = "_BaseMap";
			public static readonly string urpSpecular = "_SpecGlossMap";
			public static readonly string urpMetallic = "_MetallicGlossMap";
			public static readonly string urpNormal = "_BumpMap";
			public static readonly string urpOcclusion = "_OcclusionMap";
			public static readonly string urpParallax = "_ParallaxMap";
			public static readonly string urpEmission = "_EmissionMap";
		}
		...
		public static void registerLinkedData(Material mat, ResourceMapper resMap)
		{
			...
			//URP
			registerLinkedTex(mat, TexParamNames.urpMain, resMap);
			registerLinkedTex(mat, TexParamNames.urpSpecular, resMap);
			registerLinkedTex(mat, TexParamNames.urpMetallic, resMap);
			registerLinkedTex(mat, TexParamNames.urpNormal, resMap);
			registerLinkedTex(mat, TexParamNames.urpOcclusion, resMap);
			registerLinkedTex(mat, TexParamNames.urpParallax, resMap);
			registerLinkedTex(mat, TexParamNames.urpEmission, resMap);
		}
		...
		public static class ParamNames
		{
			...
			//URP
			public static readonly string urpMainColor = "_BaseColor";
			public static readonly string urpMetallic = "_Metallic";
			public static readonly string urpGlossiness = "_Smoothness";
			public static readonly string urpEmissionColor = "_EmissionColor";
			public static readonly string urpCutoff = "_Cutoff";
			public static readonly string urpBumpScale = "_BumpScale";
		}
		...
		public JsonMaterial(Material mat, ResourceMapper resMap)
		{
			...
			bool isUrp = shader.Contains("Universal Render Pipeline");

			if (isUrp)
			{
				mainTexture = getTexId(mat, TexParamNames.urpMain, resMap);
				mainTextureOffset = mat.HasProperty(TexParamNames.urpMain) ? mat.GetTextureOffset(TexParamNames.urpMain) : Vector2.zero;
				mainTextureScale = mat.HasProperty(TexParamNames.urpMain) ? mat.GetTextureScale(TexParamNames.urpMain) : Vector2.one;
				color = getColor(mat, ParamNames.urpMainColor, Color.white);

				albedoTex = getTexId(mat, TexParamNames.urpMain, resMap);
				specularTex = getTexId(mat, TexParamNames.urpSpecular, resMap);
				metallicTex = getTexId(mat, TexParamNames.urpMetallic, resMap);
				normalMapTex = getTexId(mat, TexParamNames.urpNormal, resMap);
				occlusionTex = getTexId(mat, TexParamNames.urpOcclusion, resMap);
				parallaxTex = getTexId(mat, TexParamNames.urpParallax, resMap);
				emissionTex = getTexId(mat, TexParamNames.urpEmission, resMap);

				alphaCutoff = getFloat(mat, ParamNames.urpCutoff, 1.0f);
				smoothness = getFloat(mat, ParamNames.urpGlossiness, 0.5f);
				metallic = getFloat(mat, ParamNames.urpMetallic, 0.5f);
				bumpScale = getFloat(mat, ParamNames.urpBumpScale, 1.0f);
				emissionColor = getColor(mat, ParamNames.urpEmissionColor, Color.black);

				useNormalMap = ExportUtility.isValidId(normalMapTex);
				useAlphaTest = mat.IsKeywordEnabled("_ALPHATEST_ON");
				useEmission = mat.IsKeywordEnabled("_EMISSION");
				useMetallic = ExportUtility.isValidId(metallicTex);
				useSpecular = ExportUtility.isValidId(specularTex);
			}
			else
			{
			...
			hasMetallic = (mat.HasProperty(ParamNames.metallic) || mat.HasProperty(ParamNames.urpMetallic)) && (mat.HasProperty(TexParamNames.metallic) || mat.HasProperty(TexParamNames.urpMetallic));
			hasSpecular = (mat.HasProperty(TexParamNames.specular) || mat.HasProperty(TexParamNames.urpSpecular)) && (mat.HasProperty(ParamNames.specularColor));
			hasEmissionColor = (mat.HasProperty(ParamNames.emissionColor) || mat.HasProperty(ParamNames.urpEmissionColor)) && (emissionColor.maxColorComponent > 0.01f);
